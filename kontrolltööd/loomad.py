...
"""
def animal_list_input():
    name = input("Please give me an animal name: ").lower().capitalize()
    while True:
        if name not in animals:
            animals.append(name)
            return name
        else:
            name = input("This animal already exists. Please give me another animal: ").lower().capitalize()
...
while True:
    animal_name_input = animal_list_input()
