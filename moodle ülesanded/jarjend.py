...
def create_list_with_edge_elements(elements: list) -> list:
    ...
    """
    edge_elements = []
    edge_elements.insert(0, elements[-1])
    edge_elements.insert(0, elements[0])
...
def get_middle_element_of_list(elements: list) -> any:
    ...
    array = [5,2,6,5,6,2,1]
    array_len = len(array)
    middle_element = array[int(array_len / 2)]
...
def swap_edge_elements(elements: list) -> list:
    ...
    edge_elements.pop(0)
    edge_elements.insert(0, last_element)

    edge_elements.pop(-1)
    edge_elements.insert(elements_length, first_element)
...
def add_element_in_position(elements: list, new_element: any, position: int) -> list:
    ...
    """
    add_element_in = elements
    add_element_in.insert(position, new_element)

    return add_element_in
